  ...
  <main>
    <div class="container">
      ...
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        ...
        <a class="btn" href="http://localhost:8000/blog/admin/login">الرجوع للصفحة الرئيسية</a>

        <img src="<?php echo assets('/img/not-found.svg') ?>" class="img-fluid py-5" alt="Page Not Found">
